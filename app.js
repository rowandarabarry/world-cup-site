      ...
      <div style="display:flex;align-items:flex-end;justify-content:center;gap:6px;margin-bottom:12px">
        ${top3[1] ? `<div style="text-align:center;flex:1">
          ...
          <div style="background:var(--navy);color:#fff;border-radius:6px 6px 0 0;padding:8px 4px;height:50px;display:flex;flex-direction:column;align-items:center;justify-content:flex-end">
            <div style="font-size:0.6rem;font-weight:700;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:100%">${top3[1].username.length > 14 ? top3[1].username.slice(0,13)+"…" : top3[1].username}</div>
        ...
        ${top3[0] ? `<div style="text-align:center;flex:1">
          ...
          <div style="background:var(--gold);color:var(--navy);border-radius:6px 6px 0 0;padding:8px 4px;height:70px;display:flex;flex-direction:column;align-items:center;justify-content:flex-end">
            <div style="font-size:0.65rem;font-weight:800;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:100%">${top3[0].username.length > 14 ? top3[0].username.slice(0,13)+"…" : top3[0].username}</div>
        ...
        ${top3[2] ? `<div style="text-align:center;flex:1">
          ...
          <div style="background:#8B6914;color:#fff;border-radius:6px 6px 0 0;padding:8px 4px;height:40px;display:flex;flex-direction:column;align-items:center;justify-content:flex-end">
            <div style="font-size:0.6rem;font-weight:700;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:100%">${top3[2].username.length > 14 ? top3[2].username.slice(0,13)+"…" : top3[2].username}</div>
  ...
  */
  const fixtures = [
    ...
    { home:'Mexico',             homeFlag:'https://flagcdn.com/w40/mx.png',
      ...
      date:'Thu 11 Jun',  time:'20:00 IST', stadium:'SoFi Stadium, Los Angeles',       group:'Group A', result:null, matchId:1 },
    { home:'Korea Republic',     homeFlag:'https://flagcdn.com/w40/kr.png',
      away:'Czechia',            awayFlag:'https://flagcdn.com/w40/cz.png',
      date:'Thu 11 Jun',  time:'03:00 IST', stadium:'SoFi Stadium, Los Angeles',       group:'Group A', result:null, matchId:2 },
    { home:'Mexico',             homeFlag:'https://flagcdn.com/w40/mx.png',
      away:'Korea Republic',     awayFlag:'https://flagcdn.com/w40/kr.png',
      date:'Mon 16 Jun',  time:'02:00 IST', stadium:'Estadio Azteca, Mexico City',     group:'Group A', result:null, matchId:25 },
    { home:'Czechia',            homeFlag:'https://flagcdn.com/w40/cz.png',
      away:'South Africa',       awayFlag:'https://flagcdn.com/w40/za.png',
      date:'Tue 17 Jun',  time:'20:00 IST', stadium:'SoFi Stadium, Los Angeles',       group:'Group A', result:null, matchId:26 },
    { home:'Czechia',            homeFlag:'https://flagcdn.com/w40/cz.png',
      away:'Mexico',             awayFlag:'https://flagcdn.com/w40/mx.png',
      date:'Sat 21 Jun',  time:'02:00 IST', stadium:'Estadio Azteca, Mexico City',     group:'Group A', result:null, matchId:49 },
    { home:'South Africa',       homeFlag:'https://flagcdn.com/w40/za.png',
      away:'Korea Republic',     awayFlag:'https://flagcdn.com/w40/kr.png',
      date:'Sat 21 Jun',  time:'02:00 IST', stadium:'SoFi Stadium, Los Angeles',       group:'Group A', result:null, matchId:50 },

    /* ── Group B ── */
    { home:'Canada',             homeFlag:'https://flagcdn.com/w40/ca.png',
      away:'Bosnia & Herz.',     awayFlag:'https://flagcdn.com/w40/ba.png',
      date:'Fri 12 Jun',  time:'20:00 IST', stadium:'BMO Field, Toronto',              group:'Group B', result:null, matchId:3 },
    { home:'Qatar',              homeFlag:'https://flagcdn.com/w40/qa.png',
      away:'Switzerland',        awayFlag:'https://flagcdn.com/w40/ch.png',
      date:'Fri 12 Jun',  time:'02:00 IST', stadium:'Levi\'s Stadium, San Francisco',  group:'Group B', result:null, matchId:4 },
    { home:'Switzerland',        homeFlag:'https://flagcdn.com/w40/ch.png',
      away:'Bosnia & Herz.',     awayFlag:'https://flagcdn.com/w40/ba.png',
      date:'Wed 18 Jun',  time:'20:00 IST', stadium:'Seattle Stadium',                 group:'Group B', result:null, matchId:27 },
    { home:'Canada',             homeFlag:'https://flagcdn.com/w40/ca.png',
      away:'Qatar',              awayFlag:'https://flagcdn.com/w40/qa.png',
      date:'Wed 18 Jun',  time:'03:00 IST', stadium:'BMO Field, Toronto',              group:'Group B', result:null, matchId:28 },
    { home:'Bosnia & Herz.',     homeFlag:'https://flagcdn.com/w40/ba.png',
      away:'Qatar',              awayFlag:'https://flagcdn.com/w40/qa.png',
      date:'Sun 22 Jun',  time:'20:00 IST', stadium:'Levi\'s Stadium, San Francisco',  group:'Group B', result:null, matchId:51 },
    { home:'Switzerland',        homeFlag:'https://flagcdn.com/w40/ch.png',
      away:'Canada',             awayFlag:'https://flagcdn.com/w40/ca.png',
      date:'Sun 22 Jun',  time:'02:00 IST', stadium:'BMO Field, Toronto',              group:'Group B', result:null, matchId:52 },

    /* ── Group C ── */
    { home:'Brazil',             homeFlag:'https://flagcdn.com/w40/br.png',
      away:'Morocco',            awayFlag:'https://flagcdn.com/w40/ma.png',
      date:'Sat 13 Jun',  time:'23:00 IST', stadium:'MetLife Stadium, New York',       group:'Group C', result:null, matchId:5 },
    { home:'Haiti',              homeFlag:'https://flagcdn.com/w40/ht.png',
      away:'Scotland',           awayFlag:'https://flagcdn.com/w40/gb-sct.png',
      date:'Sun 14 Jun',  time:'20:00 IST', stadium:'AT&T Stadium, Dallas',            group:'Group C', result:null, matchId:6 },
    { home:'Brazil',             homeFlag:'https://flagcdn.com/w40/br.png',
      away:'Haiti',              awayFlag:'https://flagcdn.com/w40/ht.png',
      date:'Thu 19 Jun',  time:'01:30 IST', stadium:'Hard Rock Stadium, Miami',        group:'Group C', result:null, matchId:29 },
    { home:'Scotland',           homeFlag:'https://flagcdn.com/w40/gb-sct.png',
      away:'Morocco',            awayFlag:'https://flagcdn.com/w40/ma.png',
      date:'Thu 19 Jun',  time:'23:00 IST', stadium:'AT&T Stadium, Dallas',            group:'Group C', result:null, matchId:30 },
    { home:'Scotland',           homeFlag:'https://flagcdn.com/w40/gb-sct.png',
      away:'Brazil',             awayFlag:'https://flagcdn.com/w40/br.png',
      date:'Mon 23 Jun',  time:'23:00 IST', stadium:'Hard Rock Stadium, Miami',        group:'Group C', result:null, matchId:53 },
    { home:'Morocco',            homeFlag:'https://flagcdn.com/w40/ma.png',
      away:'Haiti',              awayFlag:'https://flagcdn.com/w40/ht.png',
      date:'Mon 23 Jun',  time:'23:00 IST', stadium:'AT&T Stadium, Dallas',            group:'Group C', result:null, matchId:54 },

    /* ── Group D ── */
    { home:'USA',                homeFlag:'https://flagcdn.com/w40/us.png',
      away:'Paraguay',           awayFlag:'https://flagcdn.com/w40/py.png',
      date:'Sun 14 Jun',  time:'02:00 IST', stadium:'Levi\'s Stadium, San Francisco',  group:'Group D', result:null, matchId:7 },
    { home:'Australia',          homeFlag:'https://flagcdn.com/w40/au.png',
      away:'Türkiye',            awayFlag:'https://flagcdn.com/w40/tr.png',
      date:'Mon 15 Jun',  time:'17:00 IST', stadium:'Seattle Stadium',                 group:'Group D', result:null, matchId:8 },
    { home:'USA',                homeFlag:'https://flagcdn.com/w40/us.png',
      away:'Australia',          awayFlag:'https://flagcdn.com/w40/au.png',
      date:'Fri 20 Jun',  time:'20:00 IST', stadium:'Levi\'s Stadium, San Francisco',  group:'Group D', result:null, matchId:31 },
    { home:'Türkiye',            homeFlag:'https://flagcdn.com/w40/tr.png',
      away:'Paraguay',           awayFlag:'https://flagcdn.com/w40/py.png',
      date:'Fri 20 Jun',  time:'02:00 IST', stadium:'Seattle Stadium',                 group:'Group D', result:null, matchId:32 },
    { home:'Türkiye',            homeFlag:'https://flagcdn.com/w40/tr.png',
      away:'USA',                awayFlag:'https://flagcdn.com/w40/us.png',
      date:'Tue 24 Jun',  time:'03:00 IST', stadium:'Seattle Stadium',                 group:'Group D', result:null, matchId:55 },
    { home:'Paraguay',           homeFlag:'https://flagcdn.com/w40/py.png',
      away:'Australia',          awayFlag:'https://flagcdn.com/w40/au.png',
      date:'Tue 24 Jun',  time:'23:00 IST', stadium:'Levi\'s Stadium, San Francisco',  group:'Group D', result:null, matchId:56 },

    /* ── Group E ── */
    { home:'Germany',            homeFlag:'https://flagcdn.com/w40/de.png',
      away:'Curaçao',            awayFlag:'https://flagcdn.com/w40/cw.png',
      date:'Mon 15 Jun',  time:'02:00 IST', stadium:'NRG Stadium, Houston',            group:'Group E', result:null, matchId:9 },
    { home:'Côte d\'Ivoire',     homeFlag:'https://flagcdn.com/w40/ci.png',
      away:'Ecuador',            awayFlag:'https://flagcdn.com/w40/ec.png',
      date:'Mon 15 Jun',  time:'18:00 IST', stadium:'Arrowhead Stadium, Kansas City',  group:'Group E', result:null, matchId:10 },
    { home:'Germany',            homeFlag:'https://flagcdn.com/w40/de.png',
      away:'Côte d\'Ivoire',     awayFlag:'https://flagcdn.com/w40/ci.png',
      date:'Sat 21 Jun',  time:'01:00 IST', stadium:'NRG Stadium, Houston',            group:'Group E', result:null, matchId:33 },
    { home:'Ecuador',            homeFlag:'https://flagcdn.com/w40/ec.png',
      away:'Curaçao',            awayFlag:'https://flagcdn.com/w40/cw.png',
      date:'Sat 21 Jun',  time:'21:00 IST', stadium:'Arrowhead Stadium, Kansas City',  group:'Group E', result:null, matchId:34 },
    { home:'Ecuador',            homeFlag:'https://flagcdn.com/w40/ec.png',
      away:'Germany',            awayFlag:'https://flagcdn.com/w40/de.png',
      date:'Wed 25 Jun',  time:'03:00 IST', stadium:'NRG Stadium, Houston',            group:'Group E', result:null, matchId:57 },
    { home:'Curaçao',            homeFlag:'https://flagcdn.com/w40/cw.png',
      away:'Côte d\'Ivoire',     awayFlag:'https://flagcdn.com/w40/ci.png',
      date:'Wed 25 Jun',  time:'03:00 IST', stadium:'Arrowhead Stadium, Kansas City',  group:'Group E', result:null, matchId:58 },

    /* ── Group F ── */
    { home:'Netherlands',        homeFlag:'https://flagcdn.com/w40/nl.png',
      away:'Japan',              awayFlag:'https://flagcdn.com/w40/jp.png',
      date:'Mon 15 Jun',  time:'21:00 IST', stadium:'AT&T Stadium, Dallas',            group:'Group F', result:null, matchId:11 },
    { home:'Sweden',             homeFlag:'https://flagcdn.com/w40/se.png',
      away:'Tunisia',            awayFlag:'https://flagcdn.com/w40/tn.png',
      date:'Tue 17 Jun',  time:'17:00 IST', stadium:'Estadio Azteca, Mexico City',     group:'Group F', result:null, matchId:12 },
    { home:'Netherlands',        homeFlag:'https://flagcdn.com/w40/nl.png',
      away:'Sweden',             awayFlag:'https://flagcdn.com/w40/se.png',
      date:'Sun 22 Jun',  time:'18:00 IST', stadium:'AT&T Stadium, Dallas',            group:'Group F', result:null, matchId:35 },
    { home:'Tunisia',            homeFlag:'https://flagcdn.com/w40/tn.png',
      away:'Japan',              awayFlag:'https://flagcdn.com/w40/jp.png',
      date:'Sun 22 Jun',  time:'00:00 IST', stadium:'Estadio Azteca, Mexico City',     group:'Group F', result:null, matchId:36 },
    { home:'Tunisia',            homeFlag:'https://flagcdn.com/w40/tn.png',
      away:'Netherlands',        awayFlag:'https://flagcdn.com/w40/nl.png',
      date:'Thu 26 Jun',  time:'21:00 IST', stadium:'AT&T Stadium, Dallas',            group:'Group F', result:null, matchId:59 },
    { home:'Japan',              homeFlag:'https://flagcdn.com/w40/jp.png',
      away:'Sweden',             awayFlag:'https://flagcdn.com/w40/se.png',
      date:'Thu 26 Jun',  time:'00:00 IST', stadium:'Estadio Azteca, Mexico City',     group:'Group F', result:null, matchId:60 },

    /* ── Group G ── */
    { home:'Belgium',            homeFlag:'https://flagcdn.com/w40/be.png',
      away:'Egypt',              awayFlag:'https://flagcdn.com/w40/eg.png',
      date:'Tue 16 Jun',  time:'20:00 IST', stadium:'Vancouver Stadium',               group:'Group G', result:null, matchId:13 },
    { home:'IR Iran',            homeFlag:'https://flagcdn.com/w40/ir.png',
      away:'New Zealand',        awayFlag:'https://flagcdn.com/w40/nz.png',
      date:'Tue 16 Jun',  time:'02:00 IST', stadium:'Seattle Stadium',                 group:'Group G', result:null, matchId:14 },
    { home:'Belgium',            homeFlag:'https://flagcdn.com/w40/be.png',
      away:'IR Iran',            awayFlag:'https://flagcdn.com/w40/ir.png',
      date:'Sun 22 Jun',  time:'18:00 IST', stadium:'Vancouver Stadium',               group:'Group G', result:null, matchId:37 },
    { home:'New Zealand',        homeFlag:'https://flagcdn.com/w40/nz.png',
      away:'Egypt',              awayFlag:'https://flagcdn.com/w40/eg.png',
      date:'Sun 22 Jun',  time:'02:00 IST', stadium:'Seattle Stadium',                 group:'Group G', result:null, matchId:38 },
    { home:'New Zealand',        homeFlag:'https://flagcdn.com/w40/nz.png',
      away:'Belgium',            awayFlag:'https://flagcdn.com/w40/be.png',
      date:'Thu 26 Jun',  time:'21:00 IST', stadium:'Vancouver Stadium',               group:'Group G', result:null, matchId:61 },
    { home:'Egypt',              homeFlag:'https://flagcdn.com/w40/eg.png',
      away:'IR Iran',            awayFlag:'https://flagcdn.com/w40/ir.png',
      date:'Thu 26 Jun',  time:'04:00 IST', stadium:'Seattle Stadium',                 group:'Group G', result:null, matchId:62 },

    /* ── Group H ── */
    { home:'Spain',              homeFlag:'https://flagcdn.com/w40/es.png',
      away:'Cabo Verde',         awayFlag:'https://flagcdn.com/w40/cv.png',
      date:'Wed 17 Jun',  time:'18:00 IST', stadium:'Hard Rock Stadium, Miami',        group:'Group H', result:null, matchId:15 },
    { home:'Saudi Arabia',       homeFlag:'https://flagcdn.com/w40/sa.png',
      away:'Uruguay',            awayFlag:'https://flagcdn.com/w40/uy.png',
      date:'Wed 17 Jun',  time:'23:00 IST', stadium:'Levi\'s Stadium, San Francisco',  group:'Group H', result:null, matchId:16 },
    { home:'Spain',              homeFlag:'https://flagcdn.com/w40/es.png',
      away:'Saudi Arabia',       awayFlag:'https://flagcdn.com/w40/sa.png',
      date:'Mon 23 Jun',  time:'23:00 IST', stadium:'Hard Rock Stadium, Miami',        group:'Group H', result:null, matchId:39 },
    { home:'Uruguay',            homeFlag:'https://flagcdn.com/w40/uy.png',
      away:'Cabo Verde',         awayFlag:'https://flagcdn.com/w40/cv.png',
      date:'Mon 23 Jun',  time:'18:00 IST', stadium:'Levi\'s Stadium, San Francisco',  group:'Group H', result:null, matchId:40 },
    { home:'Uruguay',            homeFlag:'https://flagcdn.com/w40/uy.png',
      away:'Spain',              awayFlag:'https://flagcdn.com/w40/es.png',
      date:'Fri 27 Jun',  time:'01:00 IST', stadium:'Hard Rock Stadium, Miami',        group:'Group H', result:null, matchId:63 },
    { home:'Cabo Verde',         homeFlag:'https://flagcdn.com/w40/cv.png',
      away:'Saudi Arabia',       awayFlag:'https://flagcdn.com/w40/sa.png',
      date:'Fri 27 Jun',  time:'04:00 IST', stadium:'Levi\'s Stadium, San Francisco',  group:'Group H', result:null, matchId:64 },

    /* ── Group I ── */
    { home:'France',             homeFlag:'https://flagcdn.com/w40/fr.png',
      away:'Senegal',            awayFlag:'https://flagcdn.com/w40/sn.png',
      date:'Thu 18 Jun',  time:'23:00 IST', stadium:'MetLife Stadium, New York',       group:'Group I', result:null, matchId:17 },
    { home:'Iraq',               homeFlag:'https://flagcdn.com/w40/iq.png',
      away:'Norway',             awayFlag:'https://flagcdn.com/w40/no.png',
      date:'Thu 18 Jun',  time:'02:00 IST', stadium:'BMO Field, Toronto',              group:'Group I', result:null, matchId:18 },
    { home:'France',             homeFlag:'https://flagcdn.com/w40/fr.png',
      away:'Iraq',               awayFlag:'https://flagcdn.com/w40/iq.png',
      date:'Tue 24 Jun',  time:'22:00 IST', stadium:'MetLife Stadium, New York',       group:'Group I', result:null, matchId:41 },
    { home:'Norway',             homeFlag:'https://flagcdn.com/w40/no.png',
      away:'Senegal',            awayFlag:'https://flagcdn.com/w40/sn.png',
      date:'Tue 24 Jun',  time:'01:00 IST', stadium:'BMO Field, Toronto',              group:'Group I', result:null, matchId:42 },
    { home:'Norway',             homeFlag:'https://flagcdn.com/w40/no.png',
      away:'France',             awayFlag:'https://flagcdn.com/w40/fr.png',
      date:'Sat 28 Jun',  time:'01:00 IST', stadium:'MetLife Stadium, New York',       group:'Group I', result:null, matchId:65 },
    { home:'Senegal',            homeFlag:'https://flagcdn.com/w40/sn.png',
      away:'Iraq',               awayFlag:'https://flagcdn.com/w40/iq.png',
      date:'Sat 28 Jun',  time:'22:00 IST', stadium:'BMO Field, Toronto',              group:'Group I', result:null, matchId:66 },

    /* ── Group J ── */
    { home:'Argentina',          homeFlag:'https://flagcdn.com/w40/ar.png',
      away:'Algeria',            awayFlag:'https://flagcdn.com/w40/dz.png',
      date:'Fri 19 Jun',  time:'02:00 IST', stadium:'Mercedes-Benz Stadium, Atlanta',  group:'Group J', result:null, matchId:19 },
    { home:'Austria',            homeFlag:'https://flagcdn.com/w40/at.png',
      away:'Jordan',             awayFlag:'https://flagcdn.com/w40/jo.png',
      date:'Fri 19 Jun',  time:'17:00 IST', stadium:'Levi\'s Stadium, San Francisco',  group:'Group J', result:null, matchId:20 },
    { home:'Argentina',          homeFlag:'https://flagcdn.com/w40/ar.png',
      away:'Austria',            awayFlag:'https://flagcdn.com/w40/at.png',
      date:'Wed 25 Jun',  time:'18:00 IST', stadium:'Mercedes-Benz Stadium, Atlanta',  group:'Group J', result:null, matchId:43 },
    { home:'Jordan',             homeFlag:'https://flagcdn.com/w40/jo.png',
      away:'Algeria',            awayFlag:'https://flagcdn.com/w40/dz.png',
      date:'Wed 25 Jun',  time:'02:00 IST', stadium:'Levi\'s Stadium, San Francisco',  group:'Group J', result:null, matchId:44 },
    { home:'Jordan',             homeFlag:'https://flagcdn.com/w40/jo.png',
      away:'Argentina',          awayFlag:'https://flagcdn.com/w40/ar.png',
      date:'Sun 29 Jun',  time:'03:00 IST', stadium:'Mercedes-Benz Stadium, Atlanta',  group:'Group J', result:null, matchId:67 },
    { home:'Algeria',            homeFlag:'https://flagcdn.com/w40/dz.png',
      away:'Austria',            awayFlag:'https://flagcdn.com/w40/at.png',
      date:'Sun 29 Jun',  time:'00:30 IST', stadium:'Levi\'s Stadium, San Francisco',  group:'Group J', result:null, matchId:68 },

    /* ── Group K ── */
    { home:'Portugal',           homeFlag:'https://flagcdn.com/w40/pt.png',
      away:'Congo DR',           awayFlag:'https://flagcdn.com/w40/cd.png',
      date:'Sat 20 Jun',  time:'18:00 IST', stadium:'NRG Stadium, Houston',            group:'Group K', result:null, matchId:21 },
    { home:'Uzbekistan',         homeFlag:'https://flagcdn.com/w40/uz.png',
      away:'Colombia',           awayFlag:'https://flagcdn.com/w40/co.png',
      date:'Sat 20 Jun',  time:'03:00 IST', stadium:'Arrowhead Stadium, Kansas City',  group:'Group K', result:null, matchId:22 },
    { home:'Portugal',           homeFlag:'https://flagcdn.com/w40/pt.png',
      away:'Uzbekistan',         awayFlag:'https://flagcdn.com/w40/uz.png',
      date:'Thu 26 Jun',  time:'18:00 IST', stadium:'NRG Stadium, Houston',            group:'Group K', result:null, matchId:45 },
    { home:'Colombia',           homeFlag:'https://flagcdn.com/w40/co.png',
      away:'Congo DR',           awayFlag:'https://flagcdn.com/w40/cd.png',
      date:'Thu 26 Jun',  time:'03:00 IST', stadium:'Arrowhead Stadium, Kansas City',  group:'Group K', result:null, matchId:46 },
    { home:'Colombia',           homeFlag:'https://flagcdn.com/w40/co.png',
      away:'Portugal',           awayFlag:'https://flagcdn.com/w40/pt.png',
      date:'Mon 30 Jun',  time:'03:00 IST', stadium:'NRG Stadium, Houston',            group:'Group K', result:null, matchId:69 },
    { home:'Congo DR',           homeFlag:'https://flagcdn.com/w40/cd.png',
      away:'Uzbekistan',         awayFlag:'https://flagcdn.com/w40/uz.png',
      date:'Mon 30 Jun',  time:'00:00 IST', stadium:'Arrowhead Stadium, Kansas City',  group:'Group K', result:null, matchId:70 },

    /* ── Group L ── */
    { home:'England',            homeFlag:'https://flagcdn.com/w40/gb-eng.png',
      away:'Croatia',            awayFlag:'https://flagcdn.com/w40/hr.png',
      date:'Sun 21 Jun',  time:'21:00 IST', stadium:'MetLife Stadium, New York',       group:'Group L', result:null, matchId:23 },
    { home:'Ghana',              homeFlag:'https://flagcdn.com/w40/gh.png',
      away:'Panama',             awayFlag:'https://flagcdn.com/w40/pa.png',
      date:'Sun 21 Jun',  time:'00:00 IST', stadium:'BMO Field, Toronto',              group:'Group L', result:null, matchId:24 },
    { home:'England',            homeFlag:'https://flagcdn.com/w40/gb-eng.png',
      away:'Ghana',              awayFlag:'https://flagcdn.com/w40/gh.png',
      date:'Fri 27 Jun',  time:'22:00 IST', stadium:'MetLife Stadium, New York',       group:'Group L', result:null, matchId:47 },
    { home:'Panama',             homeFlag:'https://flagcdn.com/w40/pa.png',
      away:'Croatia',            awayFlag:'https://flagcdn.com/w40/hr.png',
      date:'Fri 27 Jun',  time:'00:00 IST', stadium:'BMO Field, Toronto',              group:'Group L', result:null, matchId:48 },
    { home:'Panama',             homeFlag:'https://flagcdn.com/w40/pa.png',
      away:'England',            awayFlag:'https://flagcdn.com/w40/gb-eng.png',
      date:'Tue 1 Jul',   time:'22:00 IST', stadium:'MetLife Stadium, New York',       group:'Group L', result:null, matchId:71 },
    { home:'Croatia',            homeFlag:'https://flagcdn.com/w40/hr.png',
      away:'Ghana',              awayFlag:'https://flagcdn.com/w40/gh.png',
      date:'Tue 1 Jul',   time:'22:00 IST', stadium:'BMO Field, Toronto',              group:'Group L', result:null, matchId:72 },
  ];
...
async function renderGroups() {
  ...
  results.filter(r => r.status === 'Played' && r.match_id <= 72).forEach(r => {
    ...
    if (tab === 'users') {
      ...
      el.innerHTML = '<h2 class="section-title" style="margin:20px 0 16px"><span>Feedback</span></h2>' +
        ...
        posts.map((fb, i) =>
          ...
          '<strong style="color:var(--purple-dark)" id="fb-title-' + i + '"></strong>' +
          ...
          '</div>' +
          '<p id="fb-content-' + i + '" style="color:var(--text-mid);font-size:0.875rem;line-height:1.6;margin:0"></p>' +
          '</div>'
        ).join('') + '</div>';
